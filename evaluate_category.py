...
def evaluate_category(zeta):
    categories = {}
    count_attr = [0]*MAX_CATEGORY #count number of records passed per level of generalization
    ...
    plt.title("Top 40 attributes/categories over threshold")
    plt.tight_layout()
